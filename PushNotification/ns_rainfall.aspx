<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="ns_rainfall.aspx.cs" Inherits="PushNotification.ns_rainfall" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
   ...
   <!-- <p>
        ...
        <asp:TextBox ID="txtXMLInfo" runat="server" Height="103px" TextMode="MultiLine" 
         ...
         <table>
         <tr>
            <asp:Label ID="lblNS" runat="server" Font-Size="Medium" Text="Nova Scotia Precipitation Amounts" 
