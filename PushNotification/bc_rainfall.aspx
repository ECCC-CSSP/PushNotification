<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="bc_rainfall.aspx.cs" Inherits="PushNotification.bc_rainfall" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
   ...
   <!-- <p>
        ...
        <asp:TextBox ID="txtXMLInfo" runat="server" Height="103px" TextMode="MultiLine" 
         ...
         <table>
         <tr>
            <asp:Label ID="lblBC" runat="server" Font-Size="Medium" Text="British Columbia Precipitation Amounts" 
