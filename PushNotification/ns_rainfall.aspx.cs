            ...
            while (i < precip.Count())
            {
                ...
                else
                {
                    if (Convert.ToDouble(gviewPrecip.Rows[i].Cells[0].Text) > Convert.ToDouble(ConfigurationManager.AppSettings["ns_limit"]))
                    {
                        ...
                        //mail.To.Add("jeffrey.stobo@ec.gc.ca,david.macarthur@ec.gc.ca,lauren.pothier@ec.gc.ca,cody.bannister@ec.gc.ca,Dave.Wood@ec.gc.ca,ryan.alexander@ec.gc.ca,charles.leblanc@ec.gc.ca,karyne.martell@ec.gc.ca");
