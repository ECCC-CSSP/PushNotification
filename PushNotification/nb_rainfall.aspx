<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="nb_rainfall.aspx.cs" Inherits="PushNotification.nb_rainfall" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
   ...
   <!-- <p>
        ...
        <asp:TextBox ID="txtXMLInfo" runat="server" Height="103px" TextMode="MultiLine" 
         ...
         <table>
         <tr>
            <asp:Label ID="lblNS" runat="server" Font-Size="Medium" Text="New Brunswick Precipitation Amounts" 
