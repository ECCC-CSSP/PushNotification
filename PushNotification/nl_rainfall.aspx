<%@ Page Language="C#"  MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="nl_rainfall.aspx.cs" Inherits="PushNotification.nl_rainfall" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
   ...
   <!-- <p>
        ...
        <asp:TextBox ID="txtXMLInfo" runat="server" Height="103px" TextMode="MultiLine" 
         ...
         <table>
         <tr>
            <asp:Label ID="lblNL" runat="server" Font-Size="Medium" Text="Newfoundland Precipitation Amounts" 
