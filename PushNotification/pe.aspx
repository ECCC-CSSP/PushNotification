<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="pe.aspx.cs" Inherits="PushNotification.pe" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
   ...
   <!-- <p>
        ...
        <asp:TextBox ID="txtXMLInfo" runat="server" Height="103px" TextMode="MultiLine" 
         ...
         <table>
         <tr>
            <asp:Label ID="lblPE" runat="server" Font-Size="Medium" Text="Prince Edward Island Precipitation Amounts" 
