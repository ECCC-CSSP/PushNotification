<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="index.aspx.cs" Inherits="PushNotification._Default" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <p>
        <br />
        <asp:Label ID="lblxmldoc" runat="server" Text="Precipitation Amounts" 
            Font-Bold="True"></asp:Label>
        <asp:TextBox ID="txtXMLInfo" runat="server" Height="103px" TextMode="MultiLine" 
            Width="853px" ReadOnly="True"></asp:TextBox>
    </p>
