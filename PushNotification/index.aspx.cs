...
namespace PushNotification
{
    public partial class _Default : System.Web.UI.Page
    {
        ...
        public void SendMail(string rainAmount, string precipStation, string timeFrame, string CMPArea)
        {
            ...
            //mail.To.Add("CSSPClosure@dfo-mpo.gc.ca,NB_CSSP_Coordination_PCCSM@inspection.gc.ca,bernice.losier@inspection.gc.ca,gilles.obrien@inspection.gc.ca,eric.chiasson@dfo-mpo.gc.ca,john.cormier@dfo-mpo.gc.ca,christopher.roberts@canada.ca,paul.klaamas@canada.ca,jeffrey.stobo@canada.ca,charles.leblanc2@canada.ca,don.walter@canada.ca,joe.pomeroy@canada.ca,ec.sqematlantique-mwqmatlantic.ec@canada.ca,florence.pelet@canada.ca,joanne.leger@dfo-mpo.gc.ca,heidi.corrigan@inspection.gc.ca,jan.tarr@inspection.gc.ca,albert.comeau@inspection.gc.ca,karine.arsenault@inspection.gc.ca,stephen.lanteigne@dfo-mpo.gc.ca,florence.albert@dfo-mpo.gc.ca,gabriel.albert@dfo-mpo.gc.ca,rachel.friolet@dfo-mpo.gc.ca,jacques.hache@dfo-mpo.gc.ca,bernard.richard@canada.ca,patrice.godin@canada.ca,celine.godin@gnb.ca,charles.leblanc2@canada.ca,joe.pomeroy@canada.ca,karyne.martell2@canada.ca");

            mail.To.Add("albert.comeau@inspection.gc.ca,bernard.richard@canada.ca,bernice.losier@inspection.gc.ca,charles.leblanc2@canada.ca,christopher.roberts@canada.ca,colette.leger@gnb.ca,crina.crain@inspection.gc.ca,CSSPClosure@dfo-mpo.gc.ca,ec.pccsm-cssp.ec@canada.ca,eric.chiasson@dfo-mpo.gc.ca,gabriel.albert@dfo-mpo.gc.ca,gilles.obrien@inspection.gc.ca,heidi.corrigan@inspection.gc.ca,Isabelle.Boudreau@dfo-mpo.gc.ca,jacques.hache@dfo-mpo.gc.ca,jan.tarr@inspection.gc.ca,jeffrey.stobo@canada.ca,joe.pomeroy@canada.ca,julieanne.richard@canada.ca,karine.arsenault@inspection.gc.ca,karyne.martell2@canada.ca,monica.ficker@dfo-mpo.gc.ca,NB_CSSP_Coordination_PCCSM@inspection.gc.ca,patrice.godin@canada.ca,paul.jiapizian@canada.ca,paul.klaamas@canada.ca,rachel.friolet@dfo-mpo.gc.ca,terry.johnston@dfo-mpo.gc.ca");
        ...
        public void SendMail2(string rainAmount, string precipStation, string timeFrame, string CMPArea)
        {
            ...
            //mail.To.Add("Regulations.XMAR@dfo-mpo.gc.ca,joe.walcott@dfo-mpo.gc.ca,NB_CSSP_Coordination_PCCSM@inspection.gc.ca,jeanniebernard11@gmail.com,Jeff.Dionne@dfo-mpo.gc.ca,bernice.losier@inspection.gc.ca,gilles.obrien@inspection.gc.ca,eric.chiasson@dfo-mpo.gc.ca,john.cormier@dfo-mpo.gc.ca,christopher.roberts@canada.ca,paul.klaamas@canada.ca,jeffrey.stobo@canada.ca,charles.leblanc2@canada.ca,don.walter@canada.ca,joe.pomeroy@canada.ca,ec.sqematlantique-mwqmatlantic.ec@canada.ca,florence.pelet@canada.ca,jan.tarr@inspection.gc.ca,heidi.corrigan@inspection.gc.ca,scott.mossman@dfo-mpo.gc.ca,edward.parker@dfo-mpo.gc.ca,jeff.cline@dfo-mpo.gc.ca,Cindy.Morrissey@dfo-mpo.gc.ca,Susan.Greenlaw@dfo-mpo.gc.ca,bernard.richard@canada.ca,patrice.godin@canada.ca,celine.godin@gnb.ca,charles.leblanc2@canada.ca,joe.pomeroy@canada.ca,karyne.martell2@canada.ca");

            mail.To.Add("bernard.richard@canada.ca,bernice.losier@inspection.gc.ca,charles.leblanc2@canada.ca,cheryl.brooking@dfo-mpo.gc.ca,christopher.roberts@canada.ca,Cindy.Morrissey@dfo-mpo.gc.ca,colette.leger@gnb.ca,crina.crain@inspection.gc.ca,ec.pccsm-cssp.ec@canada.ca,eric.chiasson@dfo-mpo.gc.ca,erin.laking@dfo-mpo.gc.ca,gail.smith@gnb.ca,gilles.obrien@inspection.gc.ca,heidi.corrigan@inspection.gc.ca,jan.tarr@inspection.gc.ca,jeff.cline@dfo-mpo.gc.ca,jeanniebernard11@gmail.com,Jeff.Dionne@dfo-mpo.gc.ca,jeffrey.stobo@canada.ca,joe.pomeroy@canada.ca,joe.walcott@dfo-mpo.gc.ca,julia.walker@dfo-mpo.gc.ca,karyne.martell2@canada.ca,lab@ecw.ngo,mark.labelle@dfo-mpo.gc.ca,michael.doon@inspection.gc.ca,monica.ficker@dfo-mpo.gc.ca,NB_CSSP_Coordination_PCCSM@inspection.gc.ca,patrice.godin@canada.ca,paul.jiapizian@canada.ca,paul.klaamas@canada.ca,Regulations.XMAR@dfo-mpo.gc.ca,scott.mossman@dfo-mpo.gc.ca,Susan.Greenlaw@dfo-mpo.gc.ca,terry.johnston@dfo-mpo.gc.ca");
            //mail.To.Add(caraList);
            //mail.To.Add(let_Dig_Bo_Oak_List);
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DateTime pocoStart = new DateTime(2019, 11, 01);
            DateTime pocoEnd = new DateTime(2020, 03, 31);
            ...
            //Oct 1 - Apr 30
            //need to take care of the date when the year changes.
            DateTime digStart = new DateTime(2019, 10, 01);
            DateTime digEnd = new DateTime(2020, 04, 30);

            //boca river & mill cove
            //Oct 1 - Apr 30
            //need to take care of the date when the year changes.
            DateTime bocMillStart = new DateTime(2019, 10, 01);
            DateTime bocMillEnd = new DateTime(2020, 04, 30);

            //oak bay & waweig river
            //Nov 1 - Mar 31
            //need to take care of the date when the year changes.
            DateTime oakWawStart = new DateTime(2019, 11, 01);
            DateTime oakWawEnd = new DateTime(2020, 03, 31);
            ...
            if (stat_Bas_val == "&nbsp;" || stat_Bas_val_prev == "&nbsp;")
            {
                if (mis_val == "&nbsp;" || mis_val_prev == "&nbsp;")
                {
                    ...
                    mail.To.Add("Ryan.Alexander@canada.ca,bernard.richard@canada.ca,Patrice.Godin@canada.ca,charles.leblanc2@canada.ca,joe.pomeroy@canada.ca,karyne.martell2@canada.ca");
