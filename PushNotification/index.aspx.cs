...
namespace PushNotification
{
    public partial class _Default : System.Web.UI.Page
    {
        ...
        public void SendTestEmail()
        {
            ...
            mail.To.Add("charles.leblanc@ec.gc.ca,Greg.Perchard@ec.gc.ca,Ryan.Alexander@ec.gc.ca,Daniel.Bastarache@ec.gc.ca,julieanne.richard@ec.gc.ca,louka.tousignant@ec.gc.ca,jeffrey.stobo@ec.gc.ca,patrice.godin@ec.gc.ca,Joe.Pomeroy@ec.gc.ca,Karyne.Martell@ec.gc.ca,pcec-pacifique-swcp-pacific@ec.gc.ca,f.dmsqepcecquebec-wqmsdswcpquebec.f@ec.gc.ca");
