...
{
    public partial class bc_rainfall : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string pageToGet = "http://131.235.1.167/PushNotification/bc.aspx";
            using (WebClient webClient = new WebClient())
            {
            ...
            while (i < precip.Count())
            {
                ...
                {   
                    if (Convert.ToDouble(gviewPrecip.Rows[i].Cells[0].Text) > Convert.ToDouble(ConfigurationManager.AppSettings["bc_limit"]))
                    {
                        ...
                        //mail.To.Add("pcec-pacifique-swcp-pacific@ec.gc.ca");
                        mail.To.Add(ConfigurationManager.AppSettings["bc_email"]);
                        ...
                        msg = "Please check rainfall levels in British Columbia.<br><br><a href='http://131.235.1.167/PushNotification/bc.aspx'>BC Rainfall</a><br><br><br><table><tr>" + response + "</tr></table>";
